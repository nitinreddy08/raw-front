...
const nextConfig = {
  ...
  env: {
    ...
    NEXT_PUBLIC_API_URL: process.env.NEXT_PUBLIC_API_URL || 'https://raw-backend-gyii.onrender.com',
    NEXT_PUBLIC_WS_URL: process.env.NEXT_PUBLIC_WS_URL || 'wss://raw-backend-gyii.onrender.com',
  },
